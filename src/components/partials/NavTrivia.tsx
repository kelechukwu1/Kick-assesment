        ...
        <SidebarMenuItem>
          {state === "collapsed" ? (
            ...
            <div className="bg-[#fefefe] space-y-2.5 p-[0.7rem] rounded-2xl text-center py-3 mb-3 md:mb-0">
              ...
              <p className="text-sm text-gray-500">Play trivia of the day to gain extra points and coins</p>
              <Link to="/trivia-of-the-day">
                <Button size={"sm"} className="text-white w-full bg-[#FF1975] hover:bg-[#d7306b] transition all duration-300 cursor-pointer font-semibold text-sm">Play trivia</Button>
              </Link>
            </div>
          )}
        </SidebarMenuItem>
