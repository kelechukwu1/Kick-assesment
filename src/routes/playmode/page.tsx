...
const PlayModePage = () => {
    return (
        <div className="w-full flex-1 flex flex-col p-8 justify-center items-center">
            <div className="w-full mb-5 lg:mt-[1.2rem]">
                <h1 className="text-md">Hey Stella.</h1>
            </div>
                ...
                <div className="flex flex-col gap-5 lg:flex-row lg:gap-10">
                    <div className="flex flex-col gap-5">
                            ...
                            {playMode.map((mode) => (
                                <div key={mode.id} className="bg-[#FCE2E2] border border-[#FA5045] flex items-center gap-5 md:gap-10 p-5 rounded-[10px] cursor-pointer lg:pr-80 hover:bg-[#e5c2c1] transition all duration 300">
                                    <img
                                        ...
                                        height={70}
                                    />
                                    <div className="text-sm uppercase text-[#333333]">{mode.mode}</div>
                                </div>
                            ))}
                        </div>
                        <div className="bg-[#F4F7FF21] backdrop-blur-xs p-5 rounded-[15px] flex flex-col items-center space-y-5 py-16 relative">
                            ...
                            <p className="text-center text-sm w-54">Take part in challenges with friends or other players</p>
                    ...
                    <div className="bg-[#FCE2E2] border border-[#FA5045] rounded-[10px] text-black p-8 lg:max-h-[38.5rem] max-w-[30.1rem] overflow-y-auto">
                        ...
                        <ul className="flex flex-col space-y-5 overflow-auto">
                            {howToPlay.map((item) => (
                                <li key={item.id} className="relative pl-5">
                                    ...
                                    <p className="text-sm font-normal text-[#616161] mb-3">{item?.paragraphOne}</p>
                                    <p className="text-sm font-normal text-[#616161] mb-3">{item?.paragraphTwo}</p>
                                    {
                                        item?.paragraphThree && (
                                            <p className="text-sm font-normal text-[#616161]">{item?.paragraphThree}</p>
                                        )
                                    }
                                </li>
                            ))}
                        ...
                        <div className="space-y-3 mt-5">
                            ...
                            <ul className="list-disc pl-5 text-sm text-[#616161]">
